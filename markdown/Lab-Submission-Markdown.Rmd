...
+---------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Student ID Numbers and Names of Group Members | \<136657 - C - Shirleen Murugi\> |
|                                                   |                                                                                                                                                                          |
|                                                   | 1.  ID - Class Group - Name                                                                                                                                              |Shirleen
|  Murugi                                                 | 136657 - C -                                                                                                                                                                         |
|                                                   | 2.  ID - Class Group - Name                                                                                                                                              |Rehema
|  jemutai                                                   |   135791 - C -                                                                                                                                                                        |
...
sapply(student_performance_dataset[, 96:99], var)
# It calculates kurtosis for specific columns of the dataset
...
ggplot(student_performance_dataset,
         aes(x = health, y = mentor,color = mentor_meetings)) +
    geom_point() +
